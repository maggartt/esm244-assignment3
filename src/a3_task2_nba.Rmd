...
At higher distances (~6) we larger trends such as high rebound players (cluster includes Joel Embiid, Giannis Antentokounmpo, Nikoa Jokic, etc.). Further research could include additional data on physical characteristics of players: height, wingspan, vertical jump height, etc. 
